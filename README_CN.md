...
- 你一天要在 Slack、Gmail、微信之间切换，但语音输入出来的东西每个地方都长一样，语气和格式还是得自己改
- 你打字打到手腕开始不舒服，不想再多一个每月 $12 的订阅费
- 你在 VSCode、终端或 AI CLI 工具里工作，不希望语音输入的结果像在发消息
- 你的音频不想送到任何人的云端——需要的是可以自己验证的东西，不是厂商说"我们很安全"就算数
- 你开过很多会，结束后什么都没记下来，需要一个不用分心就能跑的实时转录
